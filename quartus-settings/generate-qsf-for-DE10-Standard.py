...
def print_sw():
  ...
  for a in range(len(sw_pins)):
    print_lvttl3p3(f"SW[{a}]", sw_pins[a]) # Depending on JP3
print_sw()
...
def print_gpio():
  ...
  for a in range(36):
    print_lvttl3p3(f"GPIO_0[{a}]", gpio_pins[a])
print_gpio()
...
def print_hsmc():
  ...
  for key in hsmc_pin_map.keys():
    print_lvttl3p3(key, hsmc_pin_map[key]) # Depending on JP3
print_hsmc()
...
def print_hsmc_gpio():
  ...
  for a in range(36):
    print_lvttl3p3(f"GPIO_HSMC_J2[{a}]", hsmc_pin_map[gpio_hsmc_j2_name_map[a]]) # Depending on JP3
  ...
  for a in range(36):
    print_lvttl3p3(f"GPIO_HSMC_J3[{a}]", hsmc_pin_map[gpio_hsmc_j3_name_map[a]]) # Depending on JP3
print_hsmc_gpio()
...
def print_audio():
  ...
  print(f"# AUD")
  print(f"#============================================================")
  print_lvttl3p3(f"AUD_ADCLRCK", "PIN_AH29")
  print_lvttl3p3(f"AUD_ADCDAT", "PIN_AJ29")
  print_lvttl3p3(f"AUD_DACLRCK", "PIN_AG30")
  print_lvttl3p3(f"AUD_DACDAT", "PIN_AF29")
  print_lvttl3p3(f"AUD_XCK", "PIN_AH30")
  print_lvttl3p3(f"AUD_BCLK", "PIN_AF30")
print_audio()
...
def print_i2c():
  ...
  print(f"# I2C")
  print(f"#============================================================")
  print_lvttl3p3(f"FPGA_I2C_SCLK", "PIN_Y24")
  print_lvttl3p3(f"FPGA_I2C_SDAT", "PIN_Y23")
...
def print_vga():
  ...
  print_lvttl3p3(f"VGA_CLK", "PIN_AK21")
  print_lvttl3p3(f"VGA_BLANK_N", "PIN_AK22")
  print_lvttl3p3(f"VGA_HS", "PIN_AK19")
  print_lvttl3p3(f"VGA_VS", "PIN_AK18")
  print_lvttl3p3(f"VGA_SYNC_N", "PIN_AJ22")
print_vga()
...
def print_TVDecoder():
  ...
  print_lvttl3p3(f"TD_HS", "PIN_AH28")
  print_lvttl3p3(f"TD_VS", "PIN_AG28")
  print_lvttl3p3(f"TD_CLK27", "PIN_AC18")
  print_lvttl3p3(f"TD_RESET_N", "PIN_AC27")
print_TVDecoder()
...
def print_ir():
  ...
  print(f"# IR")
  print(f"#============================================================")
  print_lvttl3p3(f"IRDA_RXD", "PIN_W20")
  print_lvttl3p3(f"IRDA_TXD", "PIN_W21")
print_ir()
...
def print_ps2():
  ...
  print(f"# PS2")
  print(f"#============================================================")
  print_lvttl3p3(f"PS2_CLK", "PIN_AB25")
  print_lvttl3p3(f"PS2_DAT", "PIN_AA25")
  print_lvttl3p3(f"PS2_CLK2", "PIN_AC25")
  print_lvttl3p3(f"PS2_DAT2", "PIN_AB26")
print_ps2()
...
def print_adconv():
  ...
  print(f"# ADconverter")
  print(f"#============================================================")
  print_lvttl3p3(f"ADC_CONVST", "PIN_Y21")
  print_lvttl3p3(f"ADC_DOUT", "PIN_V23")
  print_lvttl3p3(f"ADC_DIN", "PIN_W22")
  print_lvttl3p3(f"ADC_SCLK", "PIN_W24")
print_adconv()
...
def print_hps_uart():
  ...
  print(f"# HPS_UART")
  print(f"#============================================================")
  print_lvttl3p3(f"HPS_UART_RX", "PIN_B25")
  print_lvttl3p3(f"HPS_UART_TX", "PIN_C25")
  print_lvttl3p3(f"HPS_CONV_USB_N", "PIN_B15")
print_hps_uart()
...
def print_lcd():
  ...
  print(f"# LCD")
  print(f"#============================================================")
  print_lvttl3p3(f"HPS_LCM_D_C", "PIN_C18")
  print_lvttl3p3(f"HPS_LCM_RST_N", "PIN_E17")
  print_lvttl3p3(f"HPS_LCM_SPIM_CLK", "PIN_A23")
  print_lvttl3p3(f"HPS_LCM_SPIM_MOSI", "PIN_C22")
  print_lvttl3p3(f"HPS_LCM_SPIM_SS", "PIN_H20")
print_lcd()
